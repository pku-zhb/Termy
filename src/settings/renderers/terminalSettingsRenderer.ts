...
export class TerminalSettingsRenderer extends BaseSettingsRenderer {
  ...
  private readKeybindingEntries(): KeybindingConfigEntry[] {
    ...
    const fallback: unknown = JSON.parse(DEFAULT_KEYBINDING_CONFIG_JSON);
    return Array.isArray(fallback) ? fallback as KeybindingConfigEntry[] : [];
  }
  ...
  private renderBackendSettings(containerEl: HTMLElement): void {
    ...
    const INSTALL_CMD = 'brew install pku-zhb/tap/termy-server';
