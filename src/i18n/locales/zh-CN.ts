...
export const zhCN: TranslationKeys = {
  ...
  settingsDetails: {
    terminal: {
      ...
      enrichedShellEnv: '从登录 Shell 读取 PATH',
      enrichedShellEnvDesc: 'Termy 启动时短暂运行你的登录 Shell 以读取 PATH，无需先开终端就能识别 fnm、nvm、asdf、mise、volta 等版本管理器。关闭后将跳过此操作。',
      enrichedShellEnvHint: 'PATH 来源：{{source}}',
      enrichedShellEnvHintError: 'PATH 来源：{{source}}（{{error}}）',
      enrichedShellEnvSourceLoginShell: '登录 Shell',
      enrichedShellEnvSourcePowerShell: 'PowerShell 配置文件',
      enrichedShellEnvSourceCmd: 'cmd.exe',
      enrichedShellEnvSourceProcess: '继承的 PATH',
      enrichedShellEnvSourceDisabled: '已禁用',
      enrichedShellEnvSourceUnavailable: '不可用',
