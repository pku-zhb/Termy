...
### Fixed
- Kept literal raw-space `file://` links intact when a dotted identifier such as `0133.HK` appears before the actual common file extension, while preserving arbitrary extensions at unambiguous boundaries.
